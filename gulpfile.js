var gulp         = require('gulp'), // Подключаем Gulp
    ...
    sourcemaps   = require('gulp-sourcemaps'), // Подключаем библиотеку для sourcemap
    notify       = require( 'gulp-notify' ), // Обработка ошибок 
    multipipe    = require('multipipe'); // Прогот ошибки по всему потоку
